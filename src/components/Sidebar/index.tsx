...
export const Sidebar = () => {
  ...
  return (
    <div className={`${Styles.area_sidebar} w-[30%] border-r-gray-light border-r`} id='area_sidebar'>
      <div className={`${Styles.sidebar}`} id='sidebar'>
        ...
        <div className="w-full flex flex-col pl-14 mt-10 gap-y-1">
          ...
          <label className='text-dark-gray text-xs'>{dict.sidebar.texts.last_updated}: 30/08/2023</label>
        </div>
      </div>
    </div>
  )
